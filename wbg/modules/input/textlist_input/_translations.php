...
if ($_CFG['user']['interface_language'] == 1){
	...
	define("_TXL_SURE_", "Pārliecināti?");
	define("_TXL_PARENT_CLOSED__", "Opener window is closed?");

} else if ($_CFG['user']['interface_language'] == 3) {
